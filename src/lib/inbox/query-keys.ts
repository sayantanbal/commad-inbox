export const inboxQueryKeys = {
  ...
  appContactsList: (page: number, pageSize: number, q: string) =>
    [...inboxQueryKeys.all, "contacts", "app", page, pageSize, q] as const,
  googleContacts: () => [...inboxQueryKeys.all, "contacts", "google"] as const,
